...
func FileProcess() {
	...
	absPath, err := filepath.Abs("E:\\golang\\backend\\demo\\files_server\\resources")
	if err != nil {
		log.Printf("Error while tring to read files: %v\n", err)
	}
	//absPath := "E:\\golang\\backend\\demo\\files_server\\resources"
